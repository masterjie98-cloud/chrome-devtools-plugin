...
export const INBOUND_MESSAGE_BYTE_LIMITS = {
  ...
  [WS_COMMANDS.DAEMON_AGENT_START]: 8 * 1024 * 1024,
  [WS_COMMANDS.DAEMON_AGENT_CANCEL]: 4 * 1024,
  [WS_COMMANDS.DAEMON_AGENT_BUDGET_DECISION]: 4 * 1024,
  [WS_COMMANDS.COLLABORATION_ITEM_UPSERT]: 64 * 1024,
  [WS_COMMANDS.BROWSER_ACTIVITY_EVENT]: 64 * 1024,
  [WS_COMMANDS.MCP_LIST_TOOLS]: 4 * 1024,
  [WS_COMMANDS.MCP_TOOL_CALL]: 256 * 1024,
  [WS_COMMANDS.EXTERNAL_MCP_LIST]: 4 * 1024,
  [WS_COMMANDS.EXTERNAL_MCP_UPSERT]: 128 * 1024,
  [WS_COMMANDS.EXTERNAL_MCP_REMOVE]: 4 * 1024,
  [WS_COMMANDS.EXTERNAL_MCP_SET_ENABLED]: 4 * 1024,
  [WS_COMMANDS.EXTERNAL_MCP_SET_READ_ONLY_TRUST]: 4 * 1024,
  [WS_COMMANDS.EXTERNAL_MCP_SET_AUTO_APPROVE]: 4 * 1024,
  [WS_COMMANDS.EXTERNAL_MCP_TEST]: 4 * 1024,
  ...
  [WS_COMMANDS.LOCAL_UPDATE_CHECK]: 4 * 1024,
  [WS_COMMANDS.LOCAL_UPDATE]: 4 * 1024,
  [WS_COMMANDS.LOCAL_SERVICE_STATUS]: 4 * 1024,
  [WS_COMMANDS.LOCAL_SERVICE_SET]: 4 * 1024,
...
const ROLE_COMMANDS: Record<WsClientRole, ReadonlySet<WsCommand>> = {
  browser: new Set([
    ...
    WS_COMMANDS.BROWSER_ACTIVITY_EVENT,
  ]),
  plugin: new Set([
    WS_COMMANDS.HEARTBEAT,
    WS_COMMANDS.ACTIVE_TAB_UPDATED,
  ...
  ui: new Set([
    ...
    WS_COMMANDS.MCP_LIST_TOOLS,
    WS_COMMANDS.MCP_TOOL_CALL,
    WS_COMMANDS.EXTERNAL_MCP_LIST,
    WS_COMMANDS.EXTERNAL_MCP_UPSERT,
    WS_COMMANDS.EXTERNAL_MCP_REMOVE,
    WS_COMMANDS.EXTERNAL_MCP_SET_ENABLED,
    WS_COMMANDS.EXTERNAL_MCP_SET_READ_ONLY_TRUST,
    WS_COMMANDS.EXTERNAL_MCP_SET_AUTO_APPROVE,
    WS_COMMANDS.EXTERNAL_MCP_TEST,
    WS_COMMANDS.APPROVAL_RESPONSE,
    WS_COMMANDS.TASK_GRANT_REVOKE,
    WS_COMMANDS.REQUEST_CANCEL,
    WS_COMMANDS.LOCAL_UPDATE_CHECK,
    WS_COMMANDS.LOCAL_UPDATE,
    WS_COMMANDS.LOCAL_SERVICE_STATUS,
    WS_COMMANDS.LOCAL_SERVICE_SET,
  ]),
  observer: new Set([
    WS_COMMANDS.HEARTBEAT,
    WS_COMMANDS.MCP_LIST_TOOLS,
